...
public class ModSurfaceRules {
    ...
    private static final SurfaceRules.RuleSource SAPPHIRE = makeStateRule(Blocks.DIAMOND_BLOCK);
    private static final SurfaceRules.RuleSource RAW_SAPPHIRE = makeStateRule(Blocks.RAW_COPPER_BLOCK);
