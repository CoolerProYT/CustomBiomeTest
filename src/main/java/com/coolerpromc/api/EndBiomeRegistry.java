...
public class EndBiomeRegistry
{
    ...
    static
    {
        registerHighlandsBiome(Biomes.END_HIGHLANDS, CustomBiomes.CONFIG.vanillaEndHighlandsWeight);
        registerMidlandsBiome(Biomes.END_MIDLANDS, CustomBiomes.CONFIG.vanillaEndMidlandsWeight);
        registerEdgeBiome(Biomes.END_BARRENS, CustomBiomes.CONFIG.vanillaEndBarrensWeight);
        registerIslandBiome(Biomes.SMALL_END_ISLANDS, CustomBiomes.CONFIG.vanillaSmallEndIslandsWeight);
    }
}
