...
import com.coolerpromc.worldgen.RegionUtils;
...
public abstract class Region
{
    ...
    public static final ResourceKey<Biome> DEFERRED_PLACEHOLDER = ResourceKey.create(Registries.BIOME, ResourceLocation.fromNamespaceAndPath(CustomBiomes.MOD_ID, "deferred_placeholder"));
