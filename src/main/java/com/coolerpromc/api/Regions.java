...
import com.coolerpromc.worldgen.DefaultNetherRegion;
import com.coolerpromc.worldgen.DefaultOverworldRegion;
...
public class Regions
{
    ...
    public static void register(ResourceLocation name, Region region)
    {
        ...
        CustomBiomes.LOGGER.info("Registered region " + name + " to index " + index + " for type " + region.getType());
    }
    ...
    public static void remove(RegionType type, ResourceLocation name)
    {
        ...
        CustomBiomes.LOGGER.info("Removed region " + name);
    }
    ...
    static
    {
        ...
        register(new DefaultOverworldRegion(CustomBiomes.CONFIG.vanillaOverworldRegionWeight));
        register(new DefaultNetherRegion(CustomBiomes.CONFIG.vanillaNetherRegionWeight));
    }
}
