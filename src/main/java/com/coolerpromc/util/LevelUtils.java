...
import com.coolerpromc.DimensionTypeTags;
import com.coolerpromc.api.RegionType;
import com.coolerpromc.api.Regions;
import com.coolerpromc.api.SurfaceRuleManager;
import com.coolerpromc.worldgen.IExtendedBiomeSource;
import com.coolerpromc.worldgen.IExtendedNoiseGeneratorSettings;
import com.coolerpromc.worldgen.IExtendedParameterList;
...
public class LevelUtils
{
    ...
    public static void initializeBiomes(RegistryAccess registryAccess, Holder<DimensionType> dimensionType, ResourceKey<LevelStem> levelResourceKey, ChunkGenerator chunkGenerator, long seed)
    {
        ...
        CustomBiomes.LOGGER.info(String.format("Initialized TerraBlender biomes for level stem %s", levelResourceKey.location()));
    }
}
